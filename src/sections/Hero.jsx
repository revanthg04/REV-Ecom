...
import { shoes,statistics } from "../constants/Const"
  ...
  return (
    ...
    p-2 ">
      ...
      w-full max-xl:padding-x pt-28">
        ...
        <p className="font-montserrat text-slate-gray t
        ext-lg leading-8
        mt-6 mb-14 gap-16">Designs you never seen before..</p>
        <ShopNowButton label="Shop Now" 
        iconURL={arrowRight}/>
